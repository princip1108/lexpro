...
public class EntityRecognitionResult {
    ...
    private String finalEntitiesJson;
    ...
    public String getFinalEntitiesJson() { return finalEntitiesJson; }
    public void setFinalEntitiesJson(String finalEntitiesJson) { this.finalEntitiesJson = finalEntitiesJson; }
